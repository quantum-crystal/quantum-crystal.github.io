        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-xl mx-auto md:max-w-[640px] md:mx-0 text-center md:text-left">
            {/*<div data-aos="zoom-out">
              <div
                  className="relative text-sm text-gray-300 bg-gray-800 rounded-full inline-block px-4 py-1 mb-6 before:content-[''] before:absolute before:-z-10 before:inset-0 before:-m-0.5 before:bg-gradient-to-t before:from-gray-800 before:to-gray-800 before:via-gray-600 before:rounded-full">
                <div className="text-gray-400">
                  Launching Infinite Workspaces.{' '}
                  <a className="font-medium text-blue-500 inline-flex items-center transition duration-150 ease-in-out group"
                     href="#0">
                    Learn More{' '}
                    <span
                        className="tracking-normal group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">-&gt;</span>
                  </a>
                </div>
              </div>
            </div>*/}
            <h1 className="h1 font-uncut-sans mb-6" data-aos="zoom-out" data-aos-delay="100">
              Quantum Crystal {/*<em className="font-italic">software</em>*/}
            </h1>
            <p className="text-xl text-gray-400 mb-10" data-aos="zoom-out" data-aos-delay="200">
              Our unique screens are designed to be visually stunning, providing an immersive experience for users.
            </p>
            <div
            ...
            >
              ...
              {/*<div>
                <a className="btn text-gray-300 bg-gradient-to-t from-gray-800 to-gray-700 hover:to-gray-800 w-full shadow-lg"
                   href="#0">
                  Explore Docs
                </a>
              </div>*/}
